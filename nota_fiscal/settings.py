...
SECRET_KEY = 'django-insecure-(u2)gac3nxlmvl_07(y2*dynwp!$_yk&#apqu2wh))f#2mj6+$'
...
# Configuração global de permissão e autenticação
REST_FRAMEWORK = {
...
WSGI_APPLICATION = 'nota_fiscal.wsgi.application'
